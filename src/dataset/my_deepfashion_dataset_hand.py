...
class DeepFashionDataset(Dataset):
	...
	def load_images(self, im_path):
		ims = []
		ims.append(f"final/deepfashion/cond_text_image_samples/hand-ori.png")
		texts = []
		masks = []
		poses = []
		if 'image' in self.condition_types:
		...
		if 'text' in self.condition_types:
			captions_im = []
			with open(f"final/deepfashion/cond_text_image_samples/hand-text.txt") as f:
				for line in f.readlines():
					captions_im.append(line.strip())
			texts.append(captions_im)
		if 'image' in self.condition_types:
			masks.append(f"final/deepfashion/cond_text_image_samples/hand-parsing.png")
		if 'pose' in self.condition_types:
			poses.append(f"final/deepfashion/cond_text_image_samples/hand-pose.png")
