...
from src.models.my_blocks import DownBlock, MidBlock, UpBlock
...
class VQVAE(nn.Module):
    ...
    def __init__(self, im_channels, model_config):
        ...
        ##################### Encoder ######################
        #self.encoder_scaler = nn.Conv2d(3, 3, kernel_size=(2, 1), stride=(2, 1))
        ...
        for i in range(len(self.mid_channels) - 1):
            self.encoder_mids.append(MidBlock(self.mid_channels[i], self.mid_channels[i + 1],
                                              ...
                                              norm_channels=self.norm_channels))
        # self.encoder_norm_out: GroupNorm(32, 256, eps=1e-05, affine=True)
        self.encoder_norm_out = nn.GroupNorm(self.norm_channels, self.down_channels[-1])

        # self.encoder_conv_out: Conv2d(256, 3, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        # Codebook
        # self.embedding: Embedding(8192, 3)
        ...
        #self.decoder_scaler = nn.ConvTranspose2d(3, 3, kernel_size=(2, 1), stride=(2, 1))
