...
from dataset.my_deepfashion_dataset_lower_garment import DeepFashionDataset
...
def infer(args):
    ...
    # Create the dataset
    im_dataset_cls = {
        'deepfashion_lower_garment': DeepFashionDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', dest='config_path',
                        default='../config/my_deepfashion_lower_garment.yaml', type=str)
